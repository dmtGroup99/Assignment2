iteration13 <- function(data, train_instances){
  ...
  train_set$propdiffusd <- exp(train_set$prop_log_historical_price) - train_set$price_usd
  ...
  test_set$propdiffusd <- exp(test_set$prop_log_historical_price) - test_set$price_usd

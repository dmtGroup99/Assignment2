iteration16 <- function(data, train_instances){
  ...
  num <- train[,c("srch_query_affinity_score","prop_review_score","prop_location_score1","prop_location_score2", "prop_log_historical_price","price_usd",
                  ...
                  "srch_room_count","orig_destination_distance", "position", "comp1_rate","comp2_rate","comp3_rate","comp4_rate",
                  "comp5_rate","comp6_rate","comp7_rate","comp8_rate","comp1_inv","comp2_inv","comp3_inv","comp4_inv","comp5_inv",
                  "comp6_inv","comp7_inv","comp8_inv","comp1_rate_percent_diff","comp2_rate_percent_diff","comp3_rate_percent_diff",
  ...
  train_set$comp_rate_avg <- rowMeans(train_set[,which(colnames(train_set) %in% c("comp1_rate","comp2_rate","comp3_rate","comp4_rate","comp5_rate","comp6_rate","comp7_rate","comp8_rate"))],na.rm = TRUE)
  train_set$comp_inv_avg <- rowMeans(train_set[,which(colnames(train_set) %in% c("comp1_inv","comp2_inv","comp3_inv","comp4_inv","comp5_inv","comp6_inv","comp7_inv","comp8_inv"))],na.rm = TRUE)
  
  train_set$comp_rate_sum <- rowSums(train_set[,which(colnames(train_set) %in% c("comp1_rate","comp2_rate","comp3_rate","comp4_rate","comp5_rate","comp6_rate","comp7_rate","comp8_rate"))],na.rm = TRUE)
  train_set$comp_rate_sum[which(is.na(train_set$comp_rate_avg))] <- NaN
  
  train_set$comp_inv_sum <- rowSums(train_set[,which(colnames(train_set) %in% c("comp1_inv","comp2_inv","comp3_inv","comp4_inv","comp5_inv","comp6_inv","comp7_inv","comp8_inv"))],na.rm = TRUE)
  train_set$comp_inv_sum[which(is.na(train_set$comp_inv_avg))] <- NaN
  
  train_set$comp_rate_percentage_diff <- rowMeans(train_set[,which(colnames(train_set) %in% c("comp1_rate_percent_diff","comp2_rate_percent_diff","comp3_rate_percent_diff","comp4_rate_percent_diff","comp5_rate_percent_diff","comp6_rate_percent_diff","comp7_rate_percent_diff","comp8_rate_percent_diff"))],na.rm = TRUE)
  
  train_set$price_per_day <- train_set$price_usd/train_set$srch_length_of_stay
  train_set$price_stay <- train_set$price_usd*train_set$srch_length_of_stay
  train_set$price_per_adult <- train_set$price_usd/train_set$srch_adults_count
  train_set$price_per_person <- train_set$price_usd/(train_set$srch_adults_count+train_set$srch_children_count)
  train_set$price_per_room <- train_set$price_usd/train_set$srch_room_count
  train_set <- train_set[,-which(colnames(train_set) %in% c("comp1_rate","comp2_rate","comp3_rate","comp4_rate",
                                                            "comp5_rate","comp6_rate","comp7_rate","comp8_rate","comp1_inv","comp2_inv","comp3_inv","comp4_inv","comp5_inv",
                                                            "comp6_inv","comp7_inv","comp8_inv","comp1_rate_percent_diff","comp2_rate_percent_diff","comp3_rate_percent_diff",
                                                            "comp4_rate_percent_diff","comp5_rate_percent_diff","comp6_rate_percent_diff","comp7_rate_percent_diff","comp8_rate_percent_diff",
                                                            "srch_room_count", "srch_saturday_night_bool", "srch_length_of_stay", "srch_adults_count", "srch_children_count"))]
  ...
  num <- test[,c("srch_query_affinity_score","prop_review_score","prop_location_score1","prop_location_score2", "prop_log_historical_price","price_usd",
                 "srch_length_of_stay","srch_booking_window","srch_adults_count","srch_children_count",
                 "srch_room_count","orig_destination_distance", "comp1_rate","comp2_rate","comp3_rate","comp4_rate",
                 "comp5_rate","comp6_rate","comp7_rate","comp8_rate","comp1_inv","comp2_inv","comp3_inv","comp4_inv","comp5_inv",
                 "comp6_inv","comp7_inv","comp8_inv","comp1_rate_percent_diff","comp2_rate_percent_diff","comp3_rate_percent_diff",
                 "comp4_rate_percent_diff","comp5_rate_percent_diff","comp6_rate_percent_diff","comp7_rate_percent_diff","comp8_rate_percent_diff")]
  ...
  test_set$comp_rate_avg <- rowMeans(test_set[,which(colnames(test_set) %in% c("comp1_rate","comp2_rate","comp3_rate","comp4_rate","comp5_rate","comp6_rate","comp7_rate","comp8_rate"))],na.rm = TRUE)
  test_set$comp_inv_avg <- rowMeans(test_set[,which(colnames(test_set) %in% c("comp1_inv","comp2_inv","comp3_inv","comp4_inv","comp5_inv","comp6_inv","comp7_inv","comp8_inv"))],na.rm = TRUE)
  
  test_set$comp_rate_sum <- rowSums(test_set[,which(colnames(test_set) %in% c("comp1_rate","comp2_rate","comp3_rate","comp4_rate","comp5_rate","comp6_rate","comp7_rate","comp8_rate"))],na.rm = TRUE)
  test_set$comp_rate_sum[which(is.na(test_set$comp_rate_avg))] <- NaN
  
  test_set$comp_inv_sum <- rowSums(test_set[,which(colnames(test_set) %in% c("comp1_inv","comp2_inv","comp3_inv","comp4_inv","comp5_inv","comp6_inv","comp7_inv","comp8_inv"))],na.rm = TRUE)
  test_set$comp_inv_sum[which(is.na(test_set$comp_inv_avg))] <- NaN
  
  test_set$comp_rate_percentage_diff <- rowMeans(test_set[,which(colnames(test_set) %in% c("comp1_rate_percent_diff","comp2_rate_percent_diff","comp3_rate_percent_diff","comp4_rate_percent_diff","comp5_rate_percent_diff","comp6_rate_percent_diff","comp7_rate_percent_diff","comp8_rate_percent_diff"))],na.rm = TRUE)
  
  test_set$price_per_day <- test_set$price_usd/test_set$srch_length_of_stay
  test_set$price_stay <- test_set$price_usd*test_set$srch_length_of_stay
  test_set$price_per_adult <- test_set$price_usd/test_set$srch_adults_count
  test_set$price_per_person <- test_set$price_usd/(test_set$srch_adults_count+test_set$srch_children_count)
  test_set$price_per_room <- test_set$price_usd/test_set$srch_room_count
  
  test_set <- test_set[,-which(colnames(test_set) %in% c("comp1_rate","comp2_rate","comp3_rate","comp4_rate",
                                                         "comp5_rate","comp6_rate","comp7_rate","comp8_rate","comp1_inv","comp2_inv","comp3_inv","comp4_inv","comp5_inv",
                                                         "comp6_inv","comp7_inv","comp8_inv","comp1_rate_percent_diff","comp2_rate_percent_diff","comp3_rate_percent_diff",
                                                         "comp4_rate_percent_diff","comp5_rate_percent_diff","comp6_rate_percent_diff","comp7_rate_percent_diff","comp8_rate_percent_diff",
                                                         "srch_room_count", "srch_saturday_night_bool", "srch_length_of_stay", "srch_adults_count", "srch_children_count"))]

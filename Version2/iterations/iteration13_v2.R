...
#preprocess data
source("Version2/data_scripts_v2/iteration13_v2.R")
data_new <- iteration13(data, 0.8)
...
bst <- xgb.train(data = dtrain, max.depth = 5, eta = 0.1, nthread = 7, nround = 1000, objective = "rank:pairwise", 
